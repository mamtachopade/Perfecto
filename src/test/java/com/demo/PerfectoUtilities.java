...
public class PerfectoUtilities {
	...
	public static void openApplication(String paramString) {
		try {
			...
			Reporter.log(paramString + " application did not opened", MessageTypes.Info);
		}
	}

	public static boolean findApplication(String paramString) {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("format", "name");
		String appList = (String) getDriver().executeScript("mobile:application:find", param);
		System.out.println(appList.indexOf(paramString) > -1);
		return appList.indexOf(paramString) > -1;
	}
	...
	public static void enterText(String needle) {
		String command = "mobile:typetext";
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("text", needle);
		getDriver().executeScript(command, params);
	}
	...
	public static void callDevice() {
		...
		getDriver().executeScript("mobile:gateway:call", params);
	}
